...
class gcast extends eqLogic {
	...
	public static function cronHourly(){
		$processes = array_merge(
			system::ps('gcast/resources/caster/stream2chromecast.py'),
			system::ps('gcast/core/class/../../resources/caster/stream2chromecast.py'),
			system::ps('gcast/core/class/../../resources/action.py')
		);
